...
const ContactPage = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8">We take our customer support very seriously. Please fill out the form below and we will get back to you as soon as possible.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <h2 className="text-xl font-semibold mb-4">Location</h2>
          <p className="text-gray-600">195 E Parker Square Dr, Parker, CO 801</p>
